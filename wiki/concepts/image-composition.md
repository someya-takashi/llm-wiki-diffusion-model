...
- [[character-consistency]]：合成した物体・人物を**複数枚／複数ターンにわたって**同一に保てるかという軸。1 回の合成品質を問う本ページの次に来る問題で、FLUX.1 Kontext（[[summaries/2025-flux-kontext]]）はこれを AuraFace の類似度で定量化した。
